...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    #define NEO2_COLOR_PRESETS               // Enable the Preset Color menu option for the Second Neopixel channel
     ...
     #if ENABLED(NEO2_COLOR_PRESETS, NEOPIXEL2)           //Enables the Second NeoPixel Preset Color menu option
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 1.7                // (mm) Default retract length (positive value)
